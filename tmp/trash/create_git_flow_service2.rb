module Features
  module Workflows
    class CreateGitFlowService2 < Service
      attr_reader(
        :branch_name,
        :issue_key,
        :issue_client,
      ...
      def call
        ...
        if using_current_branch?
          Log.info "Using current git branch: #{branch_name}"
        ...
        if existing_pr
          Log.info "Found existing PR ##{existing_pr['number']}: #{existing_pr['title']}"
        ...
        Open.file_code(branch_document) if branch_document
      end
      ...
      def using_current_branch?
        ...
        @using_current_branch = branch_name == Git.current_branch
      end
        ...
        Prompt.yes_no(
          ...
          yes: proc {
            if branch_name == Git.current_branch
              ...
              Log.info "Switching to existing branch '#{branch_name}'..."
      ...
      def checkout_to_base_branch
        main_branch = Git.main_branch_name
        ...
        Prompt.yes_no(
          ...
          yes: proc {
            if current_branch == main_branch
              ...
              Log.info "Switching to #{main_branch} as base branch..."
